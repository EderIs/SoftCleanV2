<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewHoteles.aspx.cs" Inherits="AppSoftClean.Vistas.Listas.ViewHoteles" %>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <h2 style="margin-top:0px"><asp:Image ID="ImgLista" CssClass="icono" ImageUrl="~/Imagenes/tienda.png" runat="server" />&nbsp Hoteles</h2>
                    </div>
                    <div class="col-lg-1">
                ...
                <div class="form-horizontal form-label-left input_mask">
                    <asp:GridView ID="dgvDatos" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Hotel" DataField="Nombre" ItemStyle-Font-Size="10" />
