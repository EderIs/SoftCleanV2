                        ...
                        <div class="form-horizontal form-label-left input_mask">
                            <asp:GridView ID="dgvDatos" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Hotel" DataField="Hoteles.Nombre" ItemStyle-Font-Size="10" />
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="DDL_Divisiones" runat="server" CssClass="form-control no-arrow text-border-azul" AutoPostBack="true" AppendDataBoundItems="true" OnSelectedIndexChanged="DDL_Divisiones_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <asp:RegularExpressionValidator ID="revFecha" runat="server" ValidationGroup="VDLevanEqui"
